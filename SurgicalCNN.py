...
# The Surgical dataset has 2 classes, tumor and normal.
NUM_CLASSES = 2

# cropped the images into patches. 
# classify each patch
...
# Build the Surgical Imaging model up to where it may be used for inference.
# --------------------------------------------------
# Args:
...
def inference(images, conv1_channels, conv2_channels, fc1_units, fc2_units):
    """Build the Surgical model up to where it may be used for inference.
    Args:
    images: Images placeholder, from inputs().
    ...
    with tf.variable_scope('conv_1') as scope:
        weights = tf.get_variable('weights', shape=[KERNEL_SIZE, KERNEL_SIZE, 91, conv1_channels], 
